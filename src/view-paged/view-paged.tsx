...
import { panResponderKey } from '../prop-types'

export default abstract class ViewPaged extends ViewPagedAbstract {
  private _scrollViewRef: typeof Animated.ScrollView
  ...
  _onPanResponderRelease = (_evt, gestureState) => {
  ...
  _scrollToPage = (
    ...
    if (this._scrollViewRef) {
      ...
      this._scrollViewRef.getNode().scrollTo({ x: offset, y: 0, animated })
    }
