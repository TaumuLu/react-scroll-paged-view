...
import ScrollPagedPlatform from './scroll-paged'
import { propTypes, defaultProps } from '../prop-types'

export default class ScrollPaged extends ScrollPagedPlatform {
  ...
  setBorderValue(startValue, endValue, maxValue) {
    ...
    this.borderDirection = isStart ? 'isStart' : isEnd ? 'isEnd' : 'none'
