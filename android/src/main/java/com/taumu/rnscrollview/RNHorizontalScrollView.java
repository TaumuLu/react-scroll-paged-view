...
public class RNHorizontalScrollView extends ReactHorizontalScrollView {
  ...
  private Class reactScrollViewClass = ReactHorizontalScrollView.class;

  public RNHorizontalScrollView(ReactContext context) {
    super(context);
  }

  public RNHorizontalScrollView(ReactContext context, @Nullable FpsListener fpsListener) {
